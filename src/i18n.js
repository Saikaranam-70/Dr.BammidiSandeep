...
i18n.use(LanguageDetecter).use(initReactI18next).init({
    ...
    resources: {
        en: {
            translation: {
                ...
                achievement5:"2025 - Certified Robotic Surgeon - SS INNOVATIONS",
                achievement6:"First to start Para Aortic Dissections",
                achievement7:"First to do HIPEC",
                achievement8:"First to do Peritonectomies",
                achievement9:"First to do Free Flap Reconstructions (Free Fibula, Free Radial Forearm Flap & Free Anterolateral Thigh Flap)",
                achievement10:"First to do complex Oral Cavity Cancer Surgeries",
                achievement11:"",
                ...
                treatment: "Treatment",
                cancer_specialist:"The FIRST Cancer Surgeon in Srikakulam & Uddanam Region",
                address:"Address",
                addressVal:"Balaga Srikakulam, Andhra Pradesh",
                ...
                total_surgeries: "Total Surgeries Performed",
  outpatient_cases: "Outpatient Cases Handled",
  nav_bt:"Book Consultation",
  home_quote:"After completing my super speciality training at one of the most prestigious institutions in India, coming back to my hometown Srikakulam, Andhra Pradesh—one of the most backward regions of the country—with a vision of giving Cancer Care to Core (CCC) is always a challenge and a happiness. Hoping to bring Quality, Affordable Cancer Care to my hometown.",
  more_than: "More than",
    list: [
      {
  ...
  orgs: [
    ...
    { name: "IMA", role: "Life Member", date: "Jul 2014 - Present" }
        ...
        hi: {
            translation: {
                home_intro: "डॉ. बम्मिडी संदीप व्यापक शल्य चिकित्सा विशेषज्ञता को रोगियों की चिंताओं की गहरी समझ के साथ जोड़ते हैं। भारत के प्रतिष्ठित ऑन्कोलॉजिस्ट्स से प्रशिक्षण और जटिल कैंसर सर्जरी करने के व्यावहारिक अनुभव ने उन्हें उन मरीजों के लिए एक विश्वसनीय विकल्प बनाया है जो उन्नत उपचार की तलाश कर रहे हैं। वे विजयनगरम, श्रीकाकुलम और उड्डनम क्षेत्रों में तृतीयक स्तर की कैंसर देखभाल लाने के लिए समर्पित हैं, ताकि मरीजों को उच्च गुणवत्ता वाला उपचार घर के करीब मिल सके। परामर्श और व्यापक कैंसर देखभाल के लिए, आप डॉ. बम्मिडी संदीप से जुड़ सकते हैं और स्वस्थ होने की दिशा में अगला कदम उठा सकते हैं।",
                ...
                cancer_specialist:"श्रीकाकुलम और उद्दानम क्षेत्र के पहले कैंसर सर्जन",
                address:"पता",
                addressVal:"बालगा श्रीकाकुलम, आंध्र प्रदेश",
                ...
                titleAwards: "सम्मान और पुरस्कार",
                 achievement6:"सबसे पहले पारा एऑर्टिक डिसेक्शन शुरू करने वाले",
                achievement7:"सबसे पहले HIPEC करने वाले",
                achievement8:"सबसे पहले पेरिटोनैक्टॉमी करने वाले",
                achievement9:"सबसे पहले फ्री फ्लैप रिकंस्ट्रक्शन करने वाले (फ्री फिबुला, फ्री रेडियल फोरआर्म फ्लैप और फ्री एंटरोलैटरल थाई फ्लैप)",
                achievement10:"सबसे पहले जटिल मौखिक कैंसर सर्जरी करने वाले",
                achievement11:"",
                total_surgeries: "कुल सर्जरी की गई",
                nav_bt:"परामर्श बुक करें",
  outpatient_cases: "बाह्य रोगी मामलों को संभाला गया",
  home_quote:"भारत के सबसे प्रतिष्ठित संस्थानों में से एक से अपनी सुपर स्पेशलिटी ट्रेनिंग पूरी करने के बाद, अपने गृहनगर आंध्र प्रदेश के श्रीकाकुलम लौटना—जो देश के सबसे पिछड़े क्षेत्रों में से एक है—कैंसर केयर टू कोर (CCC) देने की दृष्टि से हमेशा एक चुनौती और खुशी दोनों है। अपने गृहनगर में गुणवत्तापूर्ण और किफायती कैंसर उपचार लाने की आशा है।",
  more_than: "से अधिक",
    list: [
      {
...
tongue_cancer: {
  ...
  treatment: [
    ...
    "आवश्यकतानुसार पुनर्निर्माण"
        ...
        te: {
            translation: {
                home_intro: "డా. బమ్మిడి సందీప్ విస్తృత శస్త్రచికిత్సా నైపుణ్యాన్ని రోగుల సమస్యల పట్ల లోతైన అవగాహనతో కలిపి అందిస్తారు. భారతదేశంలోని ప్రముఖ ఆంకాలజిస్టుల వద్ద శిక్షణ పొందటం మరియు క్లిష్టమైన క్యాన్సర్ శస్త్రచికిత్సలు చేయడంలో ఉన్న అనుభవం ఆయనను అధునాతన చికిత్స కోరుకునే రోగులకు విశ్వసనీయ ఎంపికగా నిలబెట్టాయి. ఆయన విజయనగరం, శ్రీకాకుళం, ఉద్దానం ప్రాంతాల్లో తృతీయ స్థాయి క్యాన్సర్ చికిత్సను అందించడానికి కట్టుబడి ఉన్నారు, తద్వారా రోగులు తమ ఇళ్లకు దగ్గరగా ఉన్నతమైన చికిత్స పొందగలరు. సంప్రదింపులు మరియు సమగ్ర క్యాన్సర్ చికిత్స కోసం, మీరు డా. బమ్మిడి సందీప్‌ను సంప్రదించి, ఆరోగ్య పునరుద్ధరణ దిశగా తదుపరి అడుగు వేయవచ్చు.",
                ...
                nav_bt:"సలహా బుక్ చేయండి",
      investigations: "పరిశోధనలు",
      treatment: "చికిత్స",
      cancer_specialist:"శ్రీకాకుళం & ఉద్దానం ప్రాంతంలో మొదటి క్యాన్సర్ సర్జన్",
      address:"చిరునామా",
                addressVal:"బాలగ శ్రీకాకుళం, ఆంధ్రప్రదేశ్",
                ...
                achievement6:"మొదటిగా పారా ఆఒర్టిక్ డిసెక్షన్లు ప్రారంభించినవారు",
                achievement7:"మొదటిగా HIPEC చేసినవారు",
                achievement8:"మొదటిగా పెరిటొనెక్టమీ చేసినవారు",
                achievement9:"మొదటిగా ఫ్రీ ఫ్లాప్ రీకన్స్ట్రక్షన్లు చేసినవారు (ఫ్రీ ఫిబులా, ఫ్రీ రేడియల్ ఫోర్ ఆర్మ్ ఫ్లాప్ & ఫ్రీ యాంటరోలాటరల్ థై ఫ్లాప్)",
                achievement10:"మొదటిగా క్లిష్టమైన నోటి గది క్యాన్సర్ శస్త్రచికిత్సలు చేసినవారు",
                achievement11:"",
                total_surgeries: "మొత్తం శస్త్రచికిత్సలు చేసినవి",
  outpatient_cases: "బహిర్గత కేసులు నిర్వహించబడ్డాయి",
  home_quote:"భారతదేశంలోని ప్రతిష్టాత్మక సంస్థల్లో ఒకటిలో నా సూపర్ స్పెషాలిటీ శిక్షణ పూర్తిచేసుకుని, నా స్వస్థలం ఆంధ్రప్రదేశ్‌లోని శ్రీకాకుళానికి తిరిగి రావడం—దేశంలో అత్యంత వెనుకబడిన ప్రాంతాల్లో ఒకటిగా ఉన్నప్పటికీ—క్యాన్సర్ కేర్ టు కోర్ (CCC) అనే దృష్టితో రావడం ఒక సవాలు మరియు ఆనందం. నా స్వస్థలానికి నాణ్యమైన, అందుబాటు ధరల క్యాన్సర్ చికిత్స తీసుకురావాలని ఆశిస్తున్నాను.",
  more_than: "కన్నా ఎక్కువ",
    list: [
      {
...
tongue_cancer: {
    ...
    treatment: [
        ...
        or: {
            translation: {
                home_intro: "ଡା. ବାମ୍ମିଡି ସନ୍ଦୀପ ବ୍ୟାପକ ଶଲ୍ୟଚିକିତ୍ସା ଦକ୍ଷତାକୁ ରୋଗୀଙ୍କ ଚିନ୍ତାର ଗଭୀର ବୁ understanding ଧାନ ସହିତ ଏକତ୍ର କରନ୍ତି। ଭାରତର ପ୍ରସିଦ୍ଧ ଅଙ୍କୋଲୋଜିଷ୍ଟମାନଙ୍କ ସହିତ ପ୍ରଶିକ୍ଷଣ ଏବଂ ଜଟିଳ କ୍ୟାନ୍ସର ଶଲ୍ୟଚିକିତ୍ସା କରିବାର practically ଅଭିଜ୍ଞତା ତାଙ୍କୁ ଉନ୍ନତ ଚିକିତ୍ସା ଚାହୁଁଥିବା ରୋଗୀଙ୍କ ପାଇଁ ଏକ ନିର୍ଭରଣୀୟ ବିକଳ୍ପରେ ପରିଣତ କରିଛି। ସେ ବିଜୟନଗରମ, ଶ୍ରୀକାକୁଳମ ଏବଂ ଉଡ୍ଡାନମ ଅଞ୍ଚଳରେ ତୃତୀୟ ସ୍ତରର କ୍ୟାନ୍ସର ସୁସ୍ଥ୍ୟାୟୀ ସେବା ଆଣିବାକୁ ସମର୍ପିତ, ଯାହା ଫଳରେ ରୋଗୀମାନେ ନିଜ ଘର ପାଖରେ ଉଚ୍ଚ ଗୁଣସ୍ତରୀୟ ଚିକିତ୍ସା ପାଇପାରିବେ। ପରାମର୍ଶ ଏବଂ ସମ୍ପୂର୍ଣ୍ଣ କ୍ୟାନ୍ସର ସୁସ୍ଥ୍ୟାୟୀ ସେବା ପାଇଁ, ଆପଣ ଡା. ବାମ୍ମିଡି ସନ୍ଦୀପଙ୍କ ସହିତ ଯୋଗାଯୋଗ କରି, ସୁସ୍ଥତାର ଦିଗରେ ପରବର୍ତ୍ତୀ ପଦକ୍ଷେପ ନିଅନ୍ତୁ।",
                ...
                cancer_specialist:"ପ୍ରଥମେ ପାରା ଆଅର୍ଟିକ୍ ଡିସେକ୍ସନ୍ ଆରମ୍ଭ କରିଥିଲେ",
                address:"ଠିକଣା",
                addressVal:"ବାଲଗା ଶ୍ରୀକାକୁଳମ, ଆନ୍ଧ୍ର ପ୍ରଦେଶ",
                ...
                title: "ସଂଗଠନ",
                 ...
                 achievement6:"ପ୍ରଥମେ ପାରା ଆଅର୍ଟିକ୍ ଡିସେକ୍ସନ୍ ଆରମ୍ଭ କରିଥିଲେ",
                achievement7:"ପ୍ରଥମେ HIPEC କରିଥିଲେ",
                achievement8:"ପ୍ରଥମେ ପେରିଟୋନେକ୍ଟୋମି କରିଥିଲେ",
                achievement9:"ପ୍ରଥମେ ଫ୍ରି ଫ୍ଲାପ୍ ରିକନ୍ସଟ୍ରକ୍ସନ୍ କରିଥିଲେ (ଫ୍ରି ଫିବୁଲା, ଫ୍ରି ରେଡିଆଲ୍ ଫୋରଆର୍ମ୍ ଫ୍ଲାପ୍ ଏବଂ ଫ୍ରି ଆନ୍ଟେରୋଲାଟେରାଲ୍ ଥାଇ ଫ୍ଲାପ୍)",
                achievement10:"ପ୍ରଥମେ ଜଟିଳ ମୁଖଗୁହା କ୍ୟାନ୍ସର ସର୍ଜରୀ କରିଥିଲେ",
                achievement11:"",
                nav_bt:"ପରାମର୍ଶ ବୁକ୍ କରନ୍ତୁ",
                total_surgeries: "ମୋଟ ସର୍ଜରୀ ଅନୁଷ୍ଠିତ",
                home_quote:"ଭାରତର ସର୍ବଶ୍ରେଷ୍ଠ ସଂସ୍ଥାନମାନଙ୍କ ମଧ୍ୟରୁ ଗୋଟିଏରେ ମୋର ସୁପର ସ୍ପେସିଆଲିଟି ପ୍ରଶିକ୍ଷଣ ସମାପ୍ତ କରି, ମୋର ଜନ୍ମସ୍ଥାନ ଆନ୍ଧ୍ରପ୍ରଦେଶର ଶ୍ରୀକାକୁଳମକୁ ଫେରିବା—ଯାହା ଦେଶର ସର୍ବାଧିକ ପଛୁଆ ଅଞ୍ଚଳମାନଙ୍କ ମଧ୍ୟରୁ ଗୋଟିଏ—କ୍ୟାନ୍ସର କେୟାର ଟୁ କୋର (CCC) ଦେବାର ଦୃଷ୍ଟିଭଙ୍ଗୀ ସଦା ଏକ ଚ୍ୟାଲେଞ୍ଜ ଓ ଆନନ୍ଦ। ମୋର ଜନ୍ମସ୍ଥାନରେ ଗୁଣାତ୍ମକ ଓ ସସ୍ତା କ୍ୟାନ୍ସର ଚିକିତ୍ସା ଆଣିବାକୁ ଆଶା କରୁଛି।",
  outpatient_cases: "ବାହାରର କେସ୍ ହାଣ୍ଡଲ୍ କରାଗଲା",
  more_than: "ଠାରୁ ଅଧିକ",
    list: [
      {
